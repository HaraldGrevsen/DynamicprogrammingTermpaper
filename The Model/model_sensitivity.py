...
import dc_egm_sensitivity as egm
...
class model_s():
    ...
    def setup(self):
        ...
        par.T = 61  # Number of years, from 25 to 90
    ...
    def simulate (self):
        ...
        shape_inter = (6,par.simN)
        v_interp = np.nan + np.zeros(shape_inter)
        c_interp = np.nan + np.zeros(shape_inter)
        
        
        for t in range(par.simT):
            #for i in range(6): #Range over working full-time, part-time and not working next period  [t,:]
            ...
            v_interp[4,:] = tools.interp_2d_vec(par.grid_m,par.grid_k,sol.v[t,4,:], sim.m[t,:], sim.k[t,:])
            v_interp[5,:] = tools.interp_2d_vec(par.grid_m,par.grid_k,sol.v[t,5,:], sim.m[t,:], sim.k[t,:])
            ...
            c_interp[3,:] = tools.interp_2d_vec(par.grid_m,par.grid_k,sol.c[t,3,:], sim.m[t,:], sim.k[t,:])
            c_interp[4,:] = tools.interp_2d_vec(par.grid_m,par.grid_k,sol.c[t,4,:], sim.m[t,:], sim.k[t,:])
            c_interp[5,:] = tools.interp_2d_vec(par.grid_m,par.grid_k,sol.c[t,5,:], sim.m[t,:], sim.k[t,:])
       
        
            # Probabilities
            _, prob = egm.logsum(v_interp[0],v_interp[1],v_interp[2],v_interp[3],v_interp[4],v_interp[5],par.sigma_epsilon) 
            
                        
            # Choose h and the corresponding consumption policy function
            for n in range(par.simN):
                if 0 <= par.eps_ts[t,n] <= prob[0,n]:
                    sim.h[t,n] = par.hlist[0]
                    ...
                    if t >= par.Tp:
                        ...
                        sim.p[t,n] = 0
                        sim.s[t,n] = par.rho*sim.k[t,n]
                elif prob[0,n] < par.eps_ts[t,n] <= prob[0,n]+prob[1,n]:
                    sim.h[t,n] = par.hlist[1]
                    sim.c[t,n] = c_interp[1,n]
                elif prob[0,n]+prob[1,n] < par.eps_ts[t,n] <= prob[0,n]+prob[1,n]+prob[2,n]:
                    sim.h[t,n] = par.hlist[2]
                    sim.c[t,n] = c_interp[2,n]
                elif prob[0,n]+prob[1,n]+prob[2,n] < par.eps_ts[t,n] <= prob[0,n]+prob[1,n]+prob[2,n]+prob[3,n]:
                    sim.h[t,n] = par.hlist[3]
                    sim.c[t,n] = c_interp[3,n]
                elif prob[0,n]+prob[1,n]+prob[2,n]+prob[3,n] < par.eps_ts[t,n] <= prob[0,n]+prob[1,n]+prob[2,n]+prob[3,n]+prob[4,n]:
                    sim.h[t,n] = par.hlist[4]
                    sim.c[t,n] = c_interp[4,n]
                else:
                    sim.h[t,n] = par.hlist[5]
                    sim.c[t,n] = c_interp[5,n]

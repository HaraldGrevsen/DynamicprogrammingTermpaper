...
def EGM (sol,h,k,t,par,i_k): 
    ...
    v_raw=np.nan+np.zeros(c_raw.size)
    for i in range(c_raw.size):
        v_raw[i]=util(c_raw[i],h,par)+par.beta*w_raw[i]

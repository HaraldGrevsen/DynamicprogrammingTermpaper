...
import egm_dc_multidim4 as egm
...
class model_dc_multidim():
    ...
    def setup(self):
        ...
        par.T = 50  # Number for years, from 20 to 85
        ...
        par.phi2 = 0.6
        par.alpha = 1.5
        par.sigma_w = 0.0001   # THIS IS FOR WAGE (MIGHT BE CALLED SIGMA_W)
        ...
        # Simulation
        par.m_start = 1 # initial m in simulation
